...
namespace EPS.Libraries.ClientLibrary.HttpUtils
{
	...
	public class FileDownloaderForm : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
            ...
            // lblOverallPercent
            // 
            this.lblOverallPercent.Font = new System.Drawing.Font("Tahoma", 8.25F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
            this.lblOverallPercent.Location = new System.Drawing.Point(504, 130);
            ...
            // prgOverall
            // 
            this.prgOverall.Location = new System.Drawing.Point(12, 156);
            this.prgOverall.Name = "prgOverall";
            this.prgOverall.Size = new System.Drawing.Size(532, 16);
            ...
            this.label2.Text = "Trinity Wow Legion Installer ";
            // 
            // FileDownloaderForm
            // 
            ...
            this.Controls.Add(this.lblOverallPercent);
		...
		private void MarshalDownloadComplete()
		{
			if(this.totalSize == this.completedSize)
			{
				...
				if(!unattended)
				{
                    ...
                    if(!File.Exists("C:\\Trinity\\Legion\\WoW.mfil"))
                    {
                        Process.Start("C:\\Trinity\\Legion\\Wow.exe");
                        this.Close();
                    }
                    else
                    {
                        Process.Start("C:\\Trinity\\Legion\\Launcher.exe");
                    }
				}
				else
				{
